...
**Exposer le serivice cas de minikube:**

Tester tout d'abord l'application en terminal
...
Puis exposer via internet avec socat
...
**Transformer l'application en service (optionel)**

Créer un fichier 
/etc/systemd/system/socat-minikube-nginx.service
...
et puis recharger le `systemd` et activer le service
